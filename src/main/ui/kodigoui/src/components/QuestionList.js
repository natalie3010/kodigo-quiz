    ...
    return (
        <div>
            ...
            <button onClick={() => history(-1)} className="L-back"> &#10094; </button>
                ...
                <label className='name-label'>Question</label>
                        ...
                        {users.map(user => (
                            ...
                            <tr key={user.qid}>
                                ...
                                {/* <div className='answers-container'> */}
                                    <td className='answer-option' margin='15px'>{user.answer1}</td>
                                ...
                                {/* </div> */}
                                    <td className='pool-actions'>
                                        <button onClick={() => handleShowEdit(user.qid)}>Edit</button>
...
<Modal show={show} onHide={handleClose}>
    ...
    <Modal.Body>
        <form className='login'>
            ...
            <input className='admin--textfield' type="text" value={question} onChange={(e) => setQuestion(e.target.value)} /> <br />

            <label>Answer 1</label> <br />
            <input className='admin--textfield' type="text" value={answer1} onChange={(e) => setAnswer1(e.target.value)} /> <br />

            <label>Answer 2</label> <br />
            <input className='admin--textfield' type="text" value={answer2} onChange={(e) => setAnswer2(e.target.value)} /> <br />

            <label>Answer 3</label> <br />
            <input className='admin--textfield' type="text" value={answer3} onChange={(e) => setAnswer3(e.target.value)} /> <br />

            <label>Answer 4</label> <br />
            <input className='admin--textfield' type="text" value={answer4} onChange={(e) => setAnswer4(e.target.value)} /> <br />

            <label>Correct Answer</label> <br />
            <input className='admin--textfield' type="text" value={correct} onChange={(e) => setCorrect(e.target.value)} /> <br />
            
            <button className='admin--button' onClick={SignUp} >Add Question</button>
        </form>
...
<Modal show={showEdit} onHide={handleCloseEdit}>
    ...
    <label>Question</label> <br />
            ...
            <label>Correct Answer</label> <br />
            <input className='admin--textfield' type="text" value={correct} onChange={(e) => setCorrect(e.target.value)} /> <br />
                 <button className='admin--button' onClick={Edit} >Submit change</button>
             </form>
        ...
        <button variant="secondary" onClick={handleCloseEdit}>
            Close
                ...
                <div className='container--buttons'>
                    <button onClick={handleShow}>Create Question</button></div>
            </div>
